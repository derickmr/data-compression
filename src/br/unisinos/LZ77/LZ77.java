...
public class LZ77 {
    ...
    // compress a file
    public void encode (File source, File destination) throws IOException
    {
    ...
    public void decode (File source, File destination, File verify) throws IOException
    {
